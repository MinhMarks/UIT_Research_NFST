...
def calculate_NPD_optimized_ablation(X: np.ndarray, y: np.ndarray, epsilon: float):
    ...
    # Handle the case where epsilon is too large and rank_Pt is 0
    if rank_Pt == 0:
        return None, 0.0, 0
...
def main():
    ...
    out_path = "outputs/ablation_epsilon_results.csv"
    ...
    for prefix, scaler in DATASET_CONFIGS.items():
        ...
        for eps in EPSILON_LIST:
            ...
            try:
                ...
                W, train_time, rank_Pt = calculate_NPD_optimized_ablation(X_clustered, y_clustered, eps)
