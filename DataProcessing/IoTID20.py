...
class IoTID20():
  ...
  def __init__(base_self, seed = SEED, print_able = True) -> None:
    ...
    base_self.__fts_names = [
      f'feature_{i}' for i in range(1, 80)
    ] + ['label']
  ...
  def __set_metadata(base_self) -> None:
    base_self.__ds_name = "IoTID20"
    base_self.__ds_size = None
    base_self.__ds_fts = base_self.__fts_names
    base_self.__ds_label = base_self.__label_true_name
    base_self.__ds_paper_link = "https://www.kaggle.com/datasets/rohulaminlabid/iotid20-dataset"
    base_self.__ds_link = "https://www.kaggle.com/datasets/rohulaminlabid/iotid20-dataset"
    base_self.__csv_link = "https://www.kaggle.com/datasets/rohulaminlabid/iotid20-dataset" 
    # base_self._ds_name = ""
    ...
    if load_type=="raw":
      ...
      if os.path.exists(datadir) == True:
        ...
        if not zipfile.is_zipfile(zip_file):
            ...
            os.remove(zip_file)
            print(f"ERROR: Google Drive link expired. Please manually download IoTID20.zip to {zip_file}")
            sys.exit(1)
